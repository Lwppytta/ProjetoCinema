		...
		while (i != 0) {
			try {
				...
				System.out.println(Cores.TEXT_GREEN_BOLD + "\n1 - Filmes em cartaz" + Cores.TEXT_RESET + " | "
						...
						+ "3 - Comprar ingresso" + Cores.TEXT_RESET + " | " + Cores.TEXT_YELLOW_BOLD + "0 - Sair"
						+ Cores.TEXT_RESET);
				...
				if (controMenu == 1) {
					...
					while (i != 0) {
						...
						do {
							try {
								...
								leia.nextLine();
								System.out.println(Cores.TEXT_RED_BOLD + "Por favor digite um único número de 1 a 4."
										+ Cores.TEXT_RESET);
					...
					c1.Imprimir(lista);
					System.out.println(
							"Soma dos ingressos:  " + streamLista.mapToDouble(p -> p.getPreçoIngresso()).sum());
					System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
				}
